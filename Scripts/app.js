// apps.js, C------ Dey, "COMP125 - MidTerm Exam," contains JavaScript
...
(function () {
    ...
    function StoreAndDisplayContactInputes() {
        ...
        console.log(`%c Last Name: ${lName.value}`, "color: red;");
        console.log(`%c Contact Number: ${cNumber.value}`, "color: green;");
        console.log(`%c E-mail: ${emailInput.value}`, "color: orange;");
        console.log(`%c Message: ${message.value}`, "color: purple;");
        console.log(`%c==================================`, "font-weight: bold;");

    }

    document.getElementById("sendButton").addEventListener("click", StoreAndDisplayContactInputes);
})();
